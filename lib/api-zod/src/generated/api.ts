...
export const ExplainNodeBody = zod.object({
  ...
  shape_before: zod.string().nullish(),
  shape_after: zod.string().nullish(),
  variable_name: zod.string().nullish(),
  library: zod.string().nullish(),
  surrounding_context: zod.string().nullish(),
 ...
 */
export const SetGroqKeyBody = zod.object({
  key: zod.string(),
});

export const SetGroqKeyResponse = zod.object({
  has_key: zod.boolean(),
  source: zod.enum(["user", "env", "none"]),
  explanation_count: zod.number(),
});

/**
 * @summary Check whether a Groq key is currently configured
 */
export const GroqKeyStatusResponse = zod.object({
  has_key: zod.boolean(),
  source: zod.enum(["user", "env", "none"]),
  explanation_count: zod.number(),
});
